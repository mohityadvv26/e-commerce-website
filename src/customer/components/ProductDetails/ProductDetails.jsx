                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className="opacity-50 text-sm">56380 Ratings</p>
                                    <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">3849 Reviews</p>
                                </div>
                            </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>674587 Ratings</p>
                                </div>
                                ...
                                <Box className="mt-5 space-y-3">
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, color:"yellow" }} variant='determinate' value={10}  />
                                        </Grid>
                                    </Grid>
                                    <Grid container alignItems="center" gap={2}>
                                        <Grid item xs={2}>
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}} variant='determinate' value={70} color='error' />
                                        </Grid>
                                    </Grid>
                                </Box>
